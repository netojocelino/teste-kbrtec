...
<div class="d-flex justify-content-between mb-4">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="{{ route('admin.athletes.create') }}" class="btn btn-light">+ Cadastrar Atleta</a>
    </div>
</div>
...
<div class="bg-custom rounded overflow-hidden">
    <table class="table mb-0 table-custom table-dark align-middle">
        <thead>
            <tr>
                <th scope="col" class="text-uppercase">Atleta</th>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="{{ route('admin.athletes.edit', ['user' => $item->id]) }}" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
...
@include('pagination', ['paginator' => $athletes])
    ...
    <div class="modal-dialog modal-dialog-centered text-light">
        <div class="modal-content bg-custom">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Atleta</h1>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body d-flex flex-wrap row-gap-4">
                <div class="col-6">
                    <div><small>Atleta:</small></div>
                    <div>Admin</div>
                </div>
